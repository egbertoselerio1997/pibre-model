"""Measured-space AdaBoost regression pipeline."""
...
def tune_adaboost_regressor_hyperparameters(
    ...
    *,
    ...
    """Tune the AdaBoost regressor with Optuna."""

    params = dict(model_params) if model_params is not None else load_adaboost_regressor_params()
...
def run_adaboost_regressor_pipeline(
    ...
    *,
    ...
    """Tune, fit, evaluate, and optionally persist the AdaBoost regressor."""
...
__all__ = [
    ...
    "tune_adaboost_regressor_hyperparameters",
]