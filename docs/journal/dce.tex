...
The saved artifact paths retain the repository-internal identifier `ICSOR`, but the figures shown here correspond to ICSOR in the terminology of this manuscript.

Table~\ref{tab:icsor_density} turns the qualitative sparsity visible in the coefficient plots into a quantitative regularization diagnostic. For each output equation $y$, a coefficient is counted as retained when its absolute value satisfies $|\beta| \ge 0.001 \max_{\beta' \in \mathcal{E}_y} |\beta'|$, where $\mathcal{E}_y$ denotes the full identifiable coefficient set for that target equation. This equation-adaptive rule is preferable to a single global cutoff because the six output equations live on materially different numerical scales; in the present fit it induces absolute thresholds ranging from $5.1 \times 10^{-4}$ to $5.4 \times 10^{-2}$. Under this criterion, 603 of the 3{,}066 coefficients in the identifiable affine core are retained. The first-order terms are therefore largely preserved, but the highest-dimensional interaction block remains sparse: $\Theta_{cc,y}$ retains only 334 of 2{,}646 influent-influent interaction coefficients (12.6\%). This still indicates meaningful implicit regularization, although the compression is less severe than under the earlier blockwise threshold because the fitted surrogate continues to avoid a dense use of the quadratic basis.
...
$b_y$ & 6 & 6 & 100.0 \\
$W_{u,y}$ & 12 & 12 & 100.0 \\
$W_{in,y}$ & 126 & 119 & 94.4 \\
$\Theta_{uu,y}$ & 24 & 18 & 75.0 \\
$\Theta_{uc,y}$ & 252 & 114 & 45.2 \\
$\Theta_{cc,y}$ & 2646 & 334 & 12.6 \\
\midrule
Total & 3066 & 603 & 19.7 \\
\bottomrule
\end{tabular}
...
% Path: results/plot_results/training/ICSOR/coefficients/w_u_heatmap_20260406_183310.png
...
% Path: results/plot_results/training/ICSOR/coefficients/w_in_heatmap_20260406_183310.png
...
% Path: results/plot_results/training/ICSOR/coefficients/bias_bar_chart_20260406_183310.png
\includegraphics[width=\textwidth]{revision_plots/bias_bar_chart_20260406_183310.png}
\caption{$b_y$}
\end{subfigure}
\caption{First-order coefficient plots of the identifiable ICSOR affine core in measured space. The file paths retain the repository-internal `ICSOR` identifier, but the displayed quantities correspond to the ICSOR blocks defined in Section~2.5.}
...
% Path: results/plot_results/training/ICSOR/coefficients/theta_uu_heatmaps_20260406_183310.png
...
% Path: results/plot_results/training/ICSOR/coefficients/theta_uc_heatmaps_20260406_183310.png
...
% Path: results/plot_results/training/ICSOR/coefficients/theta_cc_heatmaps_20260406_183310.png
