...
- Downstream ML compatibility validation after ASM1 contract changes: `uv run c:/Users/eselerio/projects/pibre-model/.venv/Scripts/python.exe -m unittest tests.ml.test_collapsed_cobre tests.ml.test_ml_orchestration`.
- Measured-space model and orchestration validation: `uv run c:/Users/eselerio/projects/pibre-model/.venv/Scripts/python.exe -m unittest tests.ml.test_collapsed_cobre tests.ml.test_tabular_regressors tests.ml.test_ml_orchestration`.
- Broad regression safety sweep: `uv run c:/Users/eselerio/projects/pibre-model/.venv/Scripts/python.exe -m unittest tests.bootstrap.test_repo_contract tests.simulation.test_asm1_simulation tests.ml.test_collapsed_cobre tests.ml.test_tabular_regressors tests.ml.test_ml_orchestration`.
